    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            contents=[
                ...
                "Detect incorrect number, sign, or operator in the mathematical work, providing a box_2d for its location and a label containing the exact text transcribed from inside that box. Your entire output must be a JSON list of these detections, or an empty list [] if no errors are found.",
            ],
            config=config,
        )
